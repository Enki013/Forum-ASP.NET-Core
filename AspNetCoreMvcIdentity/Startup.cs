...
namespace AspNetCoreMvcIdentity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IDateTimeProvider, Infrastructure.DateTimeProvider>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, DataSeed dataSeed)
        {
            ...
            dataSeed.SeedSuperUser().Wait();
            dataSeed.SeedForumsAndPosts().Wait();
            dataSeed.AssignAdminRoleManually().Wait(); // Manuel rol ataması
            dataSeed.SeedRoles().Wait(); // Rol tohumlama
